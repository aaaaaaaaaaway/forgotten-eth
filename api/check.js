...
export default async function handler(req, res) {
  ...
  if (entry) {
    for (const [key, val] of Object.entries(entry)) {
      ...
      let dutchxState = typeof val === 'object' && val.dx ? val.dx : null;
      ...
      // v2 ERC20 token balances (D3 claim card) + optional redemption-token
      ...
      results[key] = {
        ...
        ...(dutchxState ? {
          dutchx: {
            weth_direct_wei: dutchxState.wd || '0',
            sai_direct_wei: dutchxState.sd || '0',
            sai_balance_wei: dutchxState.st || dutchxState.sd || '0',
            positions: dutchxState.p || [],
          },
          ...((dutchxState.st || dutchxState.sd) ? { token_balances: { SAI: dutchxState.st || dutchxState.sd } } : {}),
        } : {}),
